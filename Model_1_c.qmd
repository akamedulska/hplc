...
ggplot(data = pp_B, aes(x=variable, y=value)) + geom_boxplot(aes(fill=variable))+ coord_flip()+
...
ggplot(data = pp_T, aes(x=variable, y=value)) + geom_boxplot(aes(fill=variable))+ coord_flip()+
  theme(legend.position = "none")+ scale_x_discrete(labels=rev(lab),limits=rev)+
  labs(y="Marginal posterior distributions",x="")
...
#| warning: false
pp <- rbind(pp_B,pp_T)
ggplot(data = pp, aes(x=variable, y=value)) + geom_boxplot(aes(fill=Column))+ coord_flip()+
...
ggplot(data = pp, aes(x=variable, y=value)) + geom_boxplot(aes(fill=Column))+ coord_flip()+
  ...
  labs(y="Marginal posterior distributions",x="")+facet_wrap(~variable, labeller=lab_labeller,scales = "free_y", nrow = 16)
```